...
fps_output = 30.0  # Set the FPS of the output video
frame_size = (640, 480)  # Set the size of the output video frames

# Initialize VideoWriter object
out = cv2.VideoWriter(output_path, fourcc, fps_output, frame_size)
...
while True:
    ...
    if success:
        ...
        cv2.putText(frame, "fps:" + fps_str, (7, 70), cv2.FONT_HERSHEY_SIMPLEX,
                    1, (100, 255, 0), 2, cv2.LINE_AA)

        # Write the processed frame to the video file
        out.write(cv2.resize(frame, frame_size))  # Resize to match the output frame size
