...
from keras.models import load_model,Dense
...
if __name__ == '__main__':
    ...
    #enter your datset path
    train_generator = train_datagen.flow_from_directory(r'E:\crop 1-20',class_mode='categorical',batch_size=4, target_size = (160,160))
    ...
    savez_compressed('my_data_compressed_dataset.npz',embeddings_list,y_train_list)
